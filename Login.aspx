<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Caisa.Login" %>
                ...
                <asp:TableHeaderRow>
                  <asp:TableHeaderCell ColumnSpan="3" CssClass="text-center" >
                    ...
                    <asp:TableCell >
                        ...
                        <asp:TextBox CssClass="form-control" ID="txtcontrasena" runat="server" />
                    </asp:TableCell></asp:TableRow><asp:TableRow>
                    <asp:TableCell>
                    ...
                    </asp:TableCell></asp:TableFooterRow></asp:Table></div></form></body></html>